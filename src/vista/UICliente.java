...
public class UICliente extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       String codigoCliente = jTextField4.getText();
        ...
        // Buscar el cliente en la lista por su código
        ...
        if (clienteEncontrado != null) {
            String mensaje = "Nombre: " + clienteEncontrado.getNombreCliente() + "\n"
                    + "Telefono: " + clienteEncontrado.getTelefonoCliente() + "\n"
                    + "Correo: " + clienteEncontrado.getCorreoCliente() + "\n"
                    + "Codigo: " + clienteEncontrado.getCodigoCliente() + "\n"
                    + "Edad: " + clienteEncontrado.getEdadCliente();
